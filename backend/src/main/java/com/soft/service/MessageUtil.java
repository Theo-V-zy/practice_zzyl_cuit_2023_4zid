...
public class MessageUtil {
    ...
    public static void send(String title, String content, String type, String businessType) {
        try {
            jdbc.update("INSERT INTO t_message(title,content,message_type,receiver_type,receiver_id,read_status,enabled,business_type,create_time) VALUES(?,?,?,'admin',1,0,1,?,NOW())",
